    ...
    setConfirm: Function
        ...
        return (
            <div className="fixed left-0 -top-4 z-50 flex h-full w-full items-center justify-center bg-black bg-opacity-20">
                <div className="flex flex-col justify-center items-center bg-white p-6 w-2/5 space-y-4 rounded-2xl">
                    <div className="font-bold text-xl">
                        Payment Confirmation
                    </div>
                    <TextBox label="Password" placeholder="Fill in your password" value={password} onChange={(e) => {setPassword(e.target.value)}}/>
